...
// const QuotationInvoiceList: React.FC<QuotationInvoiceListProps> = ({
//   invoices,
//   onRefresh,
//   isDeliveryView,
//   loading,
...
//   const [activeRemarkInvoice, setActiveRemarkInvoice] =
...
//   ) => {
//     try {
//       await uploadInvoiceProof(invoiceId, file, type);
//       toast.success(`${type} proof uploaded`);
//       onRefresh();
//     } catch (error: any) {
...
//       try {
//         await deleteInvoiceProof(proofId);
...
//                   <th
//                     key={h}
//                     className="py-3.5 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400"
//                   >
//                     {h}
//                   </th>
//                 ))}
...
//                     <div className="h-3 bg-slate-100 rounded-full w-6 mx-auto" />
//                   </td>
//                   <td className="py-4 px-3">
//                     <div className="h-3 bg-slate-100 rounded-full w-20 mb-1" />
//                     <div className="h-2.5 bg-slate-100 rounded-full w-28" />
//                   </td>
//                   <td className="py-4 px-3">
//                     <div className="h-3 bg-slate-100 rounded-full w-28 mb-1" />
...
//                   </td>
//                   <td className="py-4 px-3">
//                     <div className="h-6 bg-slate-100 rounded-full w-14 mx-auto" />
//                   </td>
//                   <td className="py-4 px-3">
//                     <div className="h-6 bg-slate-100 rounded-lg w-8 mx-auto" />
//                   </td>
//                   <td className="py-4 px-3">
//                     <div className="h-6 bg-slate-100 rounded-lg w-12 mx-auto" />
//                   </td>
//                   <td className="py-4 px-3">
...
//           Create your first estimate using the "Solarica Energy India" option in
//           the creation flow.
//         </p>
//       </div>
//     );
...
//           <thead>
//             <tr className="bg-slate-50/50 border-b border-slate-100">
//               <th className="py-3.5 px-6 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 text-center w-16">
//                 #
//               </th>
//               <th className="py-3.5 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">
//                 Date & Ref
//               </th>
//               <th className="py-3.5 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">
//                 Client / Customer
...
//                 Grand Total
//               </th>
//               <th className="py-3.5 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 min-w-[160px]">
//   Issuing Company
// </th>

// <th className="py-3.5 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 text-center min-w-[120px]">
//   Lead Status
// </th>

//               {/* Find the "Grand Total" th and add these after it */}
//               <th className="py-3.5 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 text-center min-w-[120px]">
//                 Payment
//               </th>
//               <th className="py-3.5 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 text-center min-w-[100px]">
//                 Proof of Work
//               </th>
//               {isDeliveryView ? (
//                 <>
//                   <th className="px-3 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest text-left">
//                     Transport By
//                   </th>
//                   <th className="px-3 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest text-left">
//                     Ref Number
...
//               )}
//               {!isDeliveryView && (
//                 <th className="py-3.5 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 text-center">
//                   Rmks
//                 </th>
//               )}
//               <th className="py-3.5 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 text-center">
...
//               <tr>
//                 <td
//                   colSpan={isDeliveryView ? 10 : 8}
//                   className="py-8 text-center text-slate-400 text-xs font-bold uppercase tracking-widest animate-pulse"
//                 >
//                   Loading Records...
//                 </td>
//               </tr>
...
//                 <td
//                   colSpan={isDeliveryView ? 10 : 8}
//                   className="py-8 text-center text-slate-400 text-xs font-bold uppercase tracking-widest"
//                 >
//                   No records found
//                 </td>
//               </tr>
...
//                 >
//                   <td className="py-3.5 px-6 text-xs text-slate-400 font-bold text-center">
//                     {idx + 1}
//                   </td>
...
//                   {/* Find the Grand Total td and add these two columns after it */}

//                         <td className="py-3.5 px-3">
//   <div className="flex flex-col gap-0.5">
//     <span className="text-xs font-bold text-slate-700">
//       {inv.companyName || inv.lead?.companyName || "-"}
//     </span>
//   </div>
// </td>
...
//       <select
//         // value={inv.lead?.leadStatus || ""}
//         value={inv.lead?.status || ""}
//        onChange={(e) =>
...
// )
// }
//         className={`text-[10px] font-black uppercase tracking-wider px-2 py-1 rounded-lg border outline-none transition-all ${
//           inv.lead?.status === "HOT"
//             ? "bg-rose-50 text-rose-600 border-rose-200"
//             : inv.lead?.status === "WARM"
//             ? "bg-amber-50 text-amber-600 border-amber-200"
//             : inv.lead?.status   === "COLD"
...
//                       {/* Advance Payment */}
//                       {(() => {
//                         const advanceProof = inv.paymentProofs?.find(
//                           (p) => p.type === "ADVANCE",
//                         );
//                         return (
...
//                                 <div
//                                   onClick={() =>
//                                     window.open(advanceProof.imageUrl, "_blank")
//                                   }
//                                   className="size-8 rounded-lg bg-blue-50 border border-blue-200 flex items-center justify-center text-blue-500 cursor-pointer hover:bg-blue-100 transition-all"
//                                 >
//                                   <ImageIcon size={14} />
//                                 </div>
//                                 {isAdmin && (
...
//                                     if (file)
//                                       handleFileUpload(inv.id, file, "ADVANCE");
//                                   }}
//                                 />
//                                 <div className="size-8 rounded-lg bg-slate-50 border border-dashed border-slate-200 flex items-center justify-center text-slate-400 group-hover/upload:bg-blue-50 group-hover/upload:text-blue-500 transition-all">
//                                   <Camera size={14} />
//                                 </div>
//                               </label>
//                             )}
...
//                       {/* Full Payment */}
//                       {(() => {
//                         const fullProof = inv.paymentProofs?.find(
//                           (p) => p.type === "FULL",
//                         );
//                         return (
//                           <div className="flex flex-col gap-1 items-center">
...
//                                 <div
//                                   onClick={() =>
//                                     window.open(fullProof.imageUrl, "_blank")
//                                   }
//                                   className="size-8 rounded-lg bg-emerald-50 border border-emerald-200 flex items-center justify-center text-emerald-500 cursor-pointer hover:bg-emerald-100 transition-all"
//                                 >
//                                   <ImageIcon size={14} />
//                                 </div>
//                                 {isAdmin && (
//                                   <button
//                                     onClick={() =>
//                                       handleDeleteProof(fullProof.id)
//                                     }
//                                     className="absolute -top-1 -right-1 size-4 bg-rose-500 text-white rounded-full flex items-center justify-center opacity-0 group-hover/proof:opacity-100 transition-opacity shadow-sm"
//                                   >
//                                     <XCircle size={10} />
...
//                                     const file = e.target.files?.[0];
//                                     if (file)
//                                       handleFileUpload(inv.id, file, "FULL");
//                                   }}
//                                 />
//                                 <div className="size-8 rounded-lg bg-slate-50 border border-dashed border-slate-200 flex items-center justify-center text-slate-400 group-hover/upload:bg-emerald-50 group-hover/upload:text-emerald-500 transition-all">
//                                   <Upload size={14} />
//                                 </div>
//                               </label>
//                             )}
...
//                     <div className="flex justify-center">
//                       {(() => {
//                         const workProof = inv.paymentProofs?.find(
//                           (p) => p.type === "WORK",
//                         );
//                         return (
//                           <div className="flex flex-col gap-1 items-center">
...
//                                 <div
//                                   onClick={() =>
//                                     window.open(workProof.imageUrl, "_blank")
//                                   }
//                                   className="size-8 rounded-lg bg-indigo-50 border border-indigo-200 flex items-center justify-center text-indigo-500 cursor-pointer hover:bg-indigo-100 transition-all"
//                                 >
//                                   <Wrench size={14} />
//                                 </div>
//                                 {isAdmin && (
//                                   <button
//                                     onClick={() =>
//                                       handleDeleteProof(workProof.id)
//                                     }
//                                     className="absolute -top-1 -right-1 size-4 bg-rose-500 text-white rounded-full flex items-center justify-center opacity-0 group-hover/proof:opacity-100 transition-opacity shadow-sm"
//                                   >
//                                     <XCircle size={10} />
...
//                                     const file = e.target.files?.[0];
//                                     if (file)
//                                       handleFileUpload(inv.id, file, "WORK");
//                                   }}
//                                 />
//                                 <div className="size-8 rounded-lg bg-slate-50 border border-dashed border-slate-200 flex items-center justify-center text-slate-400 group-hover/upload:bg-indigo-50 group-hover/upload:text-indigo-500 transition-all">
//                                   <Upload size={14} />
//                                 </div>
//                               </label>
//                             )}
...
//                                     setUpdatingId(inv.id);
//                                     await updateInvoice(inv.id, {
//                                       transportThrough: e.target.value,
//                                     });
//                                     onRefresh();
...
//                                     options = [
//                                       "By Air Courier",
//                                       "By Commercial Flight Cargo",
//                                       "By Air Express Service",
//                                     ];
//                                   else if (mode === "by shipment")
//                                     options = [
//                                       "By Container Ship",
//                                       "By Bulk Carrier",
//                                       "By Port-to-Port Shipment",
//                                       "By Door-to-Door Sea Cargo",
//                                     ];
//                                   else if (mode === "by rail")
//                                     options = [
//                                       "By Goods Train",
//                                       "By Parcel Van",
//                                       "By Full Rake",
//                                       "By Container Rail",
//                                     ];
//                                   else if (mode === "by cargo")
//                                     options = [
//                                       "By Logistics Company",
//                                       "By Third-Party Transporter",
//                                       "By Warehouse Transfer",
//                                       "By Express Cargo Service",
//                                     ];
...
//                                 ) : (
//                                   <div
//                                     className={`size-1.5 rounded-full ${theme.dot} animate-pulse`}
//                                   />
//                                 )}
...
//                               <div className="font-bold text-rose-400 mb-1 text-center">
//                                 Rejection Reason:
//                               </div>
//                               <div className="font-medium text-slate-200 text-center">
//                                 {inv.rejectionReason}
//                               </div>
...
//                                 }}
//                                 disabled={
//                                   convertingId === inv.id || inv.isProforma
//                                 }
...
//           Total Estimates:{" "}
//           <span className="text-blue-600 ml-1">{invoices.length}</span>
//         </p>
//       </div>

//       {/* Global Loading Popup */}
//       {(viewingId || downloadingId) &&
...
interface QuotationInvoiceListProps {
  ...
  isDeliveryView?: boolean;
  loading?: boolean;
  statusFilter?: "all" | "pending" | "accepted" | "rejected"; // add this line
}
...
const QuotationInvoiceList: React.FC<QuotationInvoiceListProps> = ({
  ...
  // 1. First, filter by status (if a filter is active)
  const filteredByStatus = useMemo(() => {
    ...
    return invoices.filter((inv) => {
      ...
      if (statusFilter === "pending")
        return !["accepted", "paid", "rejected"].includes(status);
      return true;
    });
  }, [invoices, statusFilter]);

  // 2. Then apply search on the status-filtered list
  const filteredInvoices = useMemo(() => {
    ...
    return filteredByStatus.filter(
      (inv) =>
        ...
        inv.customerGstinUin?.toLowerCase().includes(term) ||
        inv.companyName?.toLowerCase().includes(term) ||
        inv.lead?.companyName?.toLowerCase().includes(term),
    );
  ...
  const handleView = async (invoice: Invoice) => {
    ...
    try {
      const { url } = isDeliveryView
        ? await getDeliveryPreviewUrl(invoice.id, date)
        : await getInvoicePreviewUrl(invoice.id);
      window.open(url, "_blank");
    } catch (error) {
      console.error("Failed to view invoice", error);
      toast.error("Could not view invoice.");
            ...
            <tbody className="divide-y divide-slate-50">
              {Array.from({ length: 5 }).map((_, i) => (
                <tr key={i} className="animate-pulse">
                  ...
                  <td className="py-4 px-3">
                    <div className="h-7 bg-slate-100 rounded-xl w-24 mx-auto" />
                  </td>
                  <td className="py-4 px-3">
                    <div className="h-7 bg-slate-100 rounded-xl w-16 mx-auto" />
                  </td>
                  {isDeliveryView ? (
                    <>
                      <td className="py-4 px-3">
                    ...
                    <>
                      <td className="py-4 px-3">
                        <div className="h-6 bg-slate-100 rounded-full w-16 mx-auto" />
                      </td>
                      <td className="py-4 px-3">
                        <div className="h-6 bg-slate-100 rounded-lg w-8 mx-auto" />
                      </td>
  ...
  return (
    ...
    <div className="bg-white border border-slate-100 shadow-xl overflow-hidden flex flex-col h-fit relative group/table">
      ...
      <div className="bg-gradient-to-r from-slate-50/80 to-white border-b border-slate-100/80 px-6 py-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-black tracking-tight text-slate-800">
              {isDeliveryView ? "Delivery Challans" : "Estimates / Invoices"}
            </h2>
            <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mt-0.5">
              Total {filteredInvoices.length} / {invoices.length} records
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search customer, invoice #, GST..."
              value={searchTerm}
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gradient-to-r from-slate-100 to-slate-50 border-b border-slate-200 sticky top-0 z-10">
              <th className="py-4 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-600 min-w-[60px] text-center">
                SR No
              </th>

              <th className="py-4 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-600 min-w-[100px]">
                Date & Ref
              </th>

              <th className="py-4 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">
                Client / Customer
              </th>
              <th className="py-4 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-600 min-w-[160px]">
                {" "}
                Grand Total
              </th>
              <th className="py-4 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-600 min-w-[160px]">
          ...
          <tbody className="divide-y divide-slate-50">
            {paginatedInvoices.length === 0 ? (
              <tr>
                <td
                  colSpan={isDeliveryView ? 12 : 11}
                  className="py-16 text-center text-slate-400 text-xs font-bold uppercase tracking-widest"
                >
      ...
      <div className="py-4 px-6 bg-slate-50/60 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-[11px] font-black text-slate-500 uppercase tracking-[0.15em]">
          Showing{" "}
          <span className="text-blue-600">{paginatedInvoices.length}</span> of{" "}
          <span className="text-blue-600">{filteredInvoices.length}</span>{" "}
          records
        </p>
