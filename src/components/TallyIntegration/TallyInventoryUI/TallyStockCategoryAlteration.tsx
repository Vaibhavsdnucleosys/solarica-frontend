...
import { getStockCategories } from '../../../services/inventoryService';
...
const TallyStockCategoryAlteration = ({ onClose, companyId, onSelect, onCreate }: Props) => {
    ...
    useEffect(() => {
        const handleKeyDown = (e: KeyboardEvent) => {
            if (e.key === 'ArrowDown') {
                ...
                else if (onSelect) onSelect(selected.name, selected.id);
        ...
        <div className="flex flex-col h-full w-full bg-[#f2f2f2] font-sans relative select-none overflow-hidden text-[13px]">
            ...
            <div className="flex justify-between items-center px-4 h-[24px] bg-[#88b5dd] text-black font-bold relative border-b border-[#2d819b] shrink-0">
                <div className="flex items-center">
                    <span>Stock Category Alteration</span>
                </div>
            ...
            <div className="flex flex-1 overflow-hidden relative">
                <div className="flex-1 bg-white flex flex-col items-center justify-start pt-10 relative">
                    <div className="w-[450px] border-2 border-[#2a5585] shadow-2xl bg-white">
                        <div className="bg-white py-1 text-center font-bold text-[#2a5585] text-[15px] underline decoration-1 underline-offset-4 relative">
                            Master Alteration
                        </div>
                        ...
                        <div className="min-h-[300px] max-h-[450px] overflow-y-auto bg-white border-b border-[#2a5585]">
                            {loading ? (
                                <div className="px-4 py-8 text-center text-gray-400 italic">Loading...</div>
                                ...
                                displayItems.map((item, idx) => (
                                    <div
                                        ...
                                        onClick={() => {
                                            ...
                                            else if (onSelect) onSelect(item.name, item.id);
                                        }}
...
export default TallyStockCategoryAlteration;
